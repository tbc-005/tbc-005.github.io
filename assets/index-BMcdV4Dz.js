...
const _hoisted_1$2 = { class: "fixed top-0 left-0 right-0 z-50 glass-effect" };
const _hoisted_2$1 = { class: "container mx-auto px-6 py-4" };
...
const _hoisted_6 = {
  ...
  target: "_blank",
  class: "p-2 rounded-lg glass-effect hover:bg-white/10 transition-colors",
  "aria-label": "GitHub"
};
const _hoisted_7 = {
  key: 0,
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "NavBar",
  setup(__props) {
    const isDark = /* @__PURE__ */ ref(true);
    const mobileMenuOpen = /* @__PURE__ */ ref(false);
    const navItems = [
      { name: "首页", path: "/", icon: House },
      { name: "技能", path: "/skills", icon: Code },
      { name: "项目", path: "/projects", icon: Briefcase },
      { name: "经历", path: "/experience", icon: Calendar },
      { name: "仪表盘", path: "/dashboard", icon: ChartColumn },
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("nav", _hoisted_1$2, [
        createBaseVNode("div", _hoisted_2$1, [
          createBaseVNode("div", _hoisted_3, [
            createVNode(_component_router_link, {
              ...
              default: withCtx(() => [..._cache[1] || (_cache[1] = [
                createBaseVNode("div", { class: "w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center" }, [
                  createBaseVNode("span", { class: "text-white font-bold text-xl" }, "C3D")
                ], -1),
                createBaseVNode("div", null, [
                  createBaseVNode("h1", { class: "text-xl font-bold gradient-text" }, "CodeCanvas 3D"),
                  createBaseVNode("p", { class: "text-xs text-gray-400 group-hover:text-gray-300 transition-colors" }, " 交互式开发者作品集 ")
                ], -1)
              ])]),
              _: 1
            }),
            createBaseVNode("div", _hoisted_4, [
              (openBlock(), createElementBlock(Fragment, null, renderList(navItems, (item) => {
                return createVNode(_component_router_link, {
                  ...
                  default: withCtx(() => [
                    (openBlock(), createBlock(resolveDynamicComponent(item.icon), { class: "w-5 h-5 mr-2" })),
            ...
            createBaseVNode("div", _hoisted_5, [
              ...
              createBaseVNode("button", {
                ...
                mobileMenuOpen.value ? (openBlock(), createBlock(unref(X), {
                  key: 1,
                  class: "w-5 h-5"
                })) : createCommentVNode("", true)
              ])
          ...
          mobileMenuOpen.value ? (openBlock(), createElementBlock("div", _hoisted_7, [
            createBaseVNode("div", _hoisted_8, [
              (openBlock(), createElementBlock(Fragment, null, renderList(navItems, (item) => {
                return createVNode(_component_router_link, {
                  ...
                  "active-class": "active",
                  onClick: _cache[0] || (_cache[0] = ($event) => mobileMenuOpen.value = false)
                }, {
                  default: withCtx(() => [
...
const NavBar = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-144836c3"]]);
const _hoisted_1$1 = { class: "glass-effect mt-20" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("footer", _hoisted_1$1, [
        createBaseVNode("div", { class: "container mx-auto px-6 py-8" }, [
          createBaseVNode("div", { class: "flex flex-col md:flex-row justify-between items-center" }, [
            _cache[1] || (_cache[1] = createStaticVNode('<div class="mb-6 md:mb-0"><div class="flex items-center space-x-3"><div class="w-8 h-8 rounded-full bg-gradient-to-r from-blue-500 to-purple-600"></div><span class="text-xl font-bold gradient-text">CodeCanvas 3D</span></div><p class="text-gray-400 text-sm mt-2"> © 2024 交互式开发者作品集. 保留所有权利. </p></div><div class="flex space-x-6"><a href="#" class="text-gray-300 hover:text-white transition-colors">隐私政策</a><a href="#" class="text-gray-300 hover:text-white transition-colors">使用条款</a><a href="#" class="text-gray-300 hover:text-white transition-colors">GitHub</a><a href="#" class="text-gray-300 hover:text-white transition-colors">联系</a></div>', 2)),
            createBaseVNode("button", {
              onClick: scrollToTop,
              class: "mt-6 md:mt-0 p-3 rounded-full glass-effect hover:bg-white/10 transition-colors",
              "aria-label": "返回顶部"
            }, [..._cache[0] || (_cache[0] = [
              createBaseVNode("span", { class: "text-lg" }, "↑", -1)
            ])])
          ]),
          _cache[2] || (_cache[2] = createBaseVNode("div", { class: "mt-8 pt-8 border-t border-gray-700" }, [
            createBaseVNode("p", { class: "text-gray-400 text-sm text-center" }, " 技术栈: Vue 3 • TypeScript • Three.js • Tailwind CSS • Vite • Pinia ")
          ], -1))
        ])
      ]);
    };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "App",
  setup(__props) {
    const threeContainer = /* @__PURE__ */ ref();
    onMounted(() => {
      console.log("页面加载完成");
    });
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", {
          ...
          ref: threeContainer,
          class: "fixed inset-0 -z-10 opacity-0"
        }, null, 512),
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b5c73525"]]);
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView-BmlFTPxm.js"), true ? [] : void 0),
      meta: {
        title: "首页 | CodeCanvas 3D"
      }
    },
    {
      path: "/test",
      name: "test",
      component: () => __vitePreload(() => import("./TestView-BPrre5pT.js"), true ? [] : void 0),
      meta: {
        title: "测试页面 | CodeCanvas 3D"
      }
    },
    {
      path: "/skills",
      name: "skills",
      component: () => __vitePreload(() => import("./SkillsView-CawzWaFG.js"), true ? [] : void 0),
      meta: {
        title: "技能展示 | CodeCanvas 3D"
      }
    },
    {
      path: "/projects",
      name: "projects",
      component: () => __vitePreload(() => import("./ProjectsView-RyCIUlke.js"), true ? [] : void 0),
      meta: {
        title: "项目展示 | CodeCanvas 3D"
      }
    },
    {
      path: "/experience",
      name: "experience",
      component: () => __vitePreload(() => import("./ExperienceView-YUuNyf-p.js"), true ? [] : void 0),
      meta: {
        title: "经历时间线 | CodeCanvas 3D"
      }
    },
    {
      path: "/dashboard",
      name: "dashboard",
      component: () => __vitePreload(() => import("./DashboardView-hxmS8YPR.js"), true ? [] : void 0),
      meta: {
        title: "数据仪表盘 | CodeCanvas 3D"
      }
    },
    {
      path: "/ecommerce",
      name: "ecommerce",
      component: () => __vitePreload(() => import("./EcommerceView-CIrVEYIe.js"), true ? [] : void 0),
      meta: {
        title: "电商管理系统 | CodeCanvas 3D"
      }
    },
    {
      path: "/data",
      name: "data",
      component: () => __vitePreload(() => import("./DataView-BV_wdjuk.js"), true ? [] : void 0),
      meta: {
        title: "数据可视化平台 | CodeCanvas 3D"
      }
    },
    {
      path: "/mobile",
      name: "mobile",
      component: () => __vitePreload(() => import("./MobileAppView-D41he4yy.js"), true ? [] : void 0),
      meta: {
        title: "移动端应用 | CodeCanvas 3D"
      }
    },
    {
      path: "/contact",
      name: "contact",
      component: () => __vitePreload(() => import("./ContactView-CdVFee1M.js"), true ? [] : void 0),
      meta: {
        title: "联系我 | CodeCanvas 3D"
      }
    },
    {
      path: "/:pathMatch(.*)*",
      name: "not-found",
      component: () => __vitePreload(() => import("./NotFoundView-CjikQfiR.js"), true ? [] : void 0),
      meta: {
        title: "页面未找到 | CodeCanvas 3D"
      }
    }
  ],
...
//# sourceMappingURL=index-BMcdV4Dz.js.map
